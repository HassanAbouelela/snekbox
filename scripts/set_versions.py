...
if ERROR_MODIFIED:
    # We're most likely running in poetry which runs python inside the scripts directory
    # making scripts/python_version inaccessible
    sys.path.insert(0, Path(__file__).parent.parent.absolute().as_posix())

from scripts.python_version import ALL_VERSIONS, MAIN_VERSION  # noqa: E402
